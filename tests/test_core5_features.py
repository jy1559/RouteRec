...
basic_builder = _load(
    "core5_basic_for_feature_test",
    ROOT / "scripts" / "build_core5_splits.py",
)
feature_driver = _load(
    "core5_feature_driver",
    ROOT / "scripts" / "build_core5_features.py",
)
...
def test_feature_stage_validate_and_atomic_publish(tmp_path: Path) -> None:
    ...
    for name in ("build_feature_dataset.py", "validate_feature_dataset.py"):
