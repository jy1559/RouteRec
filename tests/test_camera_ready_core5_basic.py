...
BUILDER = ROOT / "scripts" / "rebuild_camera_ready_core5_basic.py"
VALIDATOR = ROOT / "scripts" / "validate_camera_ready_core5_basic.py"
...
builder = _load("camera_ready_core5_builder", BUILDER)
validator = _load("camera_ready_core5_validator", VALIDATOR)
