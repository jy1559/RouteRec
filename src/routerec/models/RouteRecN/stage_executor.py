"""Unified stage executor for RouteRecN."""
...
from ..RouteRecV2.layout_schema import LayoutSpec
from ..RouteRecV2.merge_router import StageMergeRouter
...
class StageExecutorN(nn.Module):
    """Execute RouteRecN stage branches in serial or parallel mode."""
