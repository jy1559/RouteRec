#!/usr/bin/env python3
"""Build the non-overwriting camera-ready six-dataset core5 basic releases.
...
def build_staged_dataset(
    *,
    ...
    summary: dict[str, object] = {
        ...
        "camera_ready_contract": CAMERA_READY_CONTRACT,
        "status": "complete",
    ...
    *,
    ...
    try:
        ...
        validator = Path(__file__).resolve().with_name(
            "validate_camera_ready_core5_basic.py"
        )
