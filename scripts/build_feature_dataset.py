#!/usr/bin/env python3
"""Build a leakage-safe RouteRec feature dataset from frozen core5 splits.

Reads from:
  Datasets/core5_basic/{dataset}/{dataset}.inter
  Datasets/core5_basic/{dataset}/{dataset}.item

Writes to:
  Datasets/core5/{dataset}/{dataset}.inter
  Datasets/core5/{dataset}/{dataset}.item
  Datasets/core5/{dataset}/{dataset}.train.inter
  Datasets/core5/{dataset}/{dataset}.valid.inter
  Datasets/core5/{dataset}/{dataset}.test.inter
  Datasets/core5/{dataset}/feature_metadata.json
...
All fitted statistics come from training sessions. Validation and test split
membership remains frozen, and each generated feature follows the documented
causal row-information contract.
"""
...
def main() -> None:
    ...
    print("[6/7] writing feature_metadata.json")
    ...
    meta = {
        ...
        "compatibility_note": "values are bound to this prepared dataset identity and must not be mixed with another release",
        "source_hashes": source_hashes,
        "metadata_canonicalization": {
            "schema_version": 1,
            "contract": "core5-location-independent-metadata-v1",
    ...
    build_summary = {
        ...
        "timestamp_unit": str(args.timestamp_unit),
        "feature_contract_version": "core5-features-leakage-safe-v1",
        "source_hashes": source_hashes,
